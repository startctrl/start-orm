...
use PDO;
use PDOStatement;
use start\db\exception\BindParamException;
use start\db\exception\DbEventException;
use start\db\exception\DbException;
use start\db\exception\PDOException;
use start\Model;
...
abstract class PDOConnection extends Connection
{
    ...
    {
        return $this->getConfig('builder') ?: '\\start\\db\\builder\\' . ucfirst($this->getConfig('type'));
    }
