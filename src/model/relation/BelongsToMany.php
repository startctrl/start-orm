...
namespace start\model\relation;
...
class BelongsToMany extends Relation
{
    ...
    public function __construct(Model $parent, string $model, string $middle, string $foreignKey, string $localKey)
    {
        ...
        if($parent->useScope){
            ...
            $this->query  = (new $model)->db($parent->globalScope);
        }
    ...
    protected function newPivot(array $data = []): Pivot
    {
        ...
        if ($pivot instanceof Pivot) {
            ...
            throw new Exception('pivot model must extends: \start\model\Pivot');
        }
    }
