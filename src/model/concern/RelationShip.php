...
use start\db\exception\DbException as Exception;
use start\helper\Str;
use start\Model;
use start\model\Relation;
use start\model\relation\BelongsTo;
use start\model\relation\BelongsToMany;
use start\model\relation\HasMany;
use start\model\relation\HasManyThrough;
use start\model\relation\HasOne;
use start\model\relation\HasOneThrough;
use start\model\relation\MorphMany;
use start\model\relation\MorphOne;
use start\model\relation\MorphTo;
use start\model\relation\MorphToMany;
use start\model\relation\OneToOne;
...
trait RelationShip
{
    ...
    protected function isRelationAttr(string $attr)
    {
        ...
        if ((method_exists($this, $relation) && !method_exists('start\Model', $relation)) || isset(static::$macro[static::class][$relation])) {
            return $relation;
        }
